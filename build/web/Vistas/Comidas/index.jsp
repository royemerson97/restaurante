...
<html>
    ...
    <body>
        ...
        <div class="container">
            <a href="ComidasController?action=nuevo">Nuevo</a>
            <table class="table">
                <thead>
                    <tr>
                        <th>id</th>
                ...
                <tbody>
                    <c:forEach var="comida" items="${lista}">
                        <tr>
                            ...
                            <td><c:out value="${comida.id_tipo_comida}"/></td>
                            <td><c:out value="${comida.comida}"/></td>
                            <td><c:out value="${comida.precio}"/></td>
                            <td><a href="ComidasController?action=showedit&id=<c:out value="${comida.id}" />">Editar</a></td>
                            <td><a href="ComidasController?action=eliminar&id=<c:out value="${comida.id}"/>">Eliminar</a> </td>				
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
