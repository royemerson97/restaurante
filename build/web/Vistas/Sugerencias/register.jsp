...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form action="SugerenciasController?action=register" method="post">
                ...
                <div class="form-group"> 
                    ...
                    <input type="text" class="form-control" name="sugerencia"/>
                </div>
               <div class="form-group"> 
                    <label>Publicada</label>
                    <input type="number" class="form-control" name="publicada"/>
                </div>
                <br>
