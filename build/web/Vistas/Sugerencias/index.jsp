...
<html>
    ...
    <body>
        ...
        <div class="container">
            <a href="SugerenciasController?action=nuevo">Nuevo</a>
            <table class="table">
                <thead>
                    <tr>
                        <th>id</th>
                ...
                <tbody>
                    <c:forEach var="su" items="${lista}">
                        <tr>
                            <td><c:out value="${su.id}"/></td>
                            <td><c:out value="${su.id_usuario}"/></td>
                            <td><c:out value="${su.sugerencia}"/></td>
                            <td><c:out value="${su.publicada}"/></td>
                            <td><a href="SugerenciasController?action=showedit&id=<c:out value="${su.id}" />">Editar</a></td>
                            <td><a href="SugerenciasController?action=eliminar&id=<c:out value="${su.id}"/>">Eliminar</a> </td>				
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
